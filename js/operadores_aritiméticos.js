...
document.write('A soma entre ' + num1 +' + '+ num2 +' é :</br></br><strong>' + (num1 + num2)+'</strong></br></br><hr></br>')

document.write('A subtração entre '+ num1 +' - '+ num2 +' é :</br></br><strong>' + (num1 - num2)+'</strong></br></br><hr></br>')

document.write('A multiplicação entre '+ num1 +' x '+ num2 +' é :</br></br><strong>' + (num1 * num2)+'</strong></br></br><hr></br>')

document.write('A divisão entre '+ num1 +' ÷ '+ num2 +' é :</br></br><strong>' + (num1 / num2)+'</strong></br></br><hr></br>')

document.write('A modulo ou sobra da divisão entre '+ num1 +' % '+ num2 +' é :</br></br><strong>' + (num1 % num2)+'</strong></br></br><hr></br>')
...
document.write('Pós Decremento -- a direita diminiu - 1 resultando em <strong>' + num1 +'</strong>')
document.write('</br></br><hr></br>')
...
document.write('Pós Decremento -- a direita diminiu - 1 resultando em <strong>' + num2 +'</strong>')
document.write('</br></br><hr></br>')
